...
public abstract class AbstractFormat extends java.text.NumberFormat implements java.io.Serializable {
	 ...
	 */ 	public void setDenominatorFormat(final java.text.NumberFormat format) { 		if (format == null) { 			throw new org.apache.commons.math.exception.NullArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.DENOMINATOR_FORMAT);
		}
	 ...
	 * @throws NullArgumentException
	 * 		if {@code format} is {@code null}.
	 */ 	public void setNumeratorFormat(final java.text.NumberFormat format) { 		if (format == null) { 			throw new org.apache.commons.math.exception.NullArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.NUMERATOR_FORMAT);
		}
