...
public class ExceptionContext implements java.io.Serializable {
	 ...
	 */ 	public ExceptionContext(final java.lang.Throwable throwable) { 		this.throwable = throwable; 		msgPatterns = new java.util.ArrayList<org.apache.commons.math.exception.util.Localizable>();
