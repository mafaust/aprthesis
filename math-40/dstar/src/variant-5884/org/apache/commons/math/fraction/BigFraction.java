...
org.apache.commons.math.FieldElement<org.apache.commons.math.fraction.BigFraction> , java.lang.Comparable<org.apache.commons.math.fraction.BigFraction> , java.io.Serializable {
	 ...
	 */ 	public BigFraction(java.math.BigInteger num, java.math.BigInteger den) { 		org.apache.commons.math.util.MathUtils.checkNotNull(num, org.apache.commons.math.exception.util.LocalizedFormats.NUMERATOR); 		org.apache.commons.math.util.MathUtils.checkNotNull(den, org.apache.commons.math.exception.util.LocalizedFormats.DENOMINATOR); 		if (java.math.BigInteger.ZERO.equals(den)) {
	 ...
	 */ 	public BigFraction(final double value) throws org.apache.commons.math.exception.MathIllegalArgumentException { 		if (java.lang.Double.isNaN(value)) { 			throw new org.apache.commons.math.exception.MathIllegalArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.NAN_VALUE_CONVERSION);
		}
	...
	org.apache.commons.math.fraction.FractionConversionException {
		...
		do {
			...
			if (((n < maxIterations) && 
			(org.apache.commons.math.util.FastMath.abs(convergent - value) > epsilon)) && 
			(q2 < maxDenominator)) {
				p0 = p1;
				p1 = p2;
				q0 = q1;
	 ...
	 * @throws ZeroException
	 * 		if the fraction to divide by is zero.
	 */ 	public org.apache.commons.math.fraction.BigFraction divide(final org.apache.commons.math.fraction.BigFraction fraction) { 		if (fraction == null) { 			throw new org.apache.commons.math.exception.NullArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.FRACTION);
		}
	 ...
	 */ 	public org.apache.commons.math.fraction.BigFraction multiply(final java.math.BigInteger bg) { 		if (bg == null) {
	 ...
	 */ 	public org.apache.commons.math.fraction.BigFraction multiply(final org.apache.commons.math.fraction.BigFraction fraction) { 		if (fraction == null) {
			throw new org.apache.commons.math.exception.NullArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.FRACTION);
		}
	...
	public org.apache.commons.math.fraction.BigFraction pow(final long exponent) {
		if (exponent < 0) {
			return new org.apache.commons.math.fraction.BigFraction(org.apache.commons.math.util.ArithmeticUtils.pow(denominator, -exponent), 
			org.apache.commons.math.util.ArithmeticUtils.pow(numerator, -exponent));
		}
		return new org.apache.commons.math.fraction.BigFraction(org.apache.commons.math.util.ArithmeticUtils.pow(numerator, exponent), 
		org.apache.commons.math.util.ArithmeticUtils.pow(denominator, exponent));
	}
	...
	public org.apache.commons.math.fraction.BigFraction pow(final java.math.BigInteger exponent) {
		if (exponent.compareTo(java.math.BigInteger.ZERO) < 0) {
			...
			return new org.apache.commons.math.fraction.BigFraction(org.apache.commons.math.util.ArithmeticUtils.pow(denominator, eNeg), 
			org.apache.commons.math.util.ArithmeticUtils.pow(numerator, eNeg));
		}
		return new org.apache.commons.math.fraction.BigFraction(org.apache.commons.math.util.ArithmeticUtils.pow(numerator, exponent), 
		org.apache.commons.math.util.ArithmeticUtils.pow(denominator, exponent));
	}
	...
	public double pow(final double exponent) {
		return org.apache.commons.math.util.FastMath.pow(numerator.doubleValue(), exponent) / 
		org.apache.commons.math.util.FastMath.pow(denominator.doubleValue(), exponent);
	}
	 ...
	 */ 	public org.apache.commons.math.fraction.BigFraction subtract(final java.math.BigInteger bg) { 		if (bg == null) {
			throw new org.apache.commons.math.exception.NullArgumentException();
		}
	 ...
	 * @throws NullArgumentException
	 * 		if the {@code fraction} is {@code null}.
	 */ 	public org.apache.commons.math.fraction.BigFraction subtract(final org.apache.commons.math.fraction.BigFraction fraction) { 		if (fraction == null) {
			throw new org.apache.commons.math.exception.NullArgumentException(org.apache.commons.math.exception.util.LocalizedFormats.FRACTION);
		}
		if (org.apache.commons.math.fraction.BigFraction.ZERO.equals(fraction)) {
			return this;
