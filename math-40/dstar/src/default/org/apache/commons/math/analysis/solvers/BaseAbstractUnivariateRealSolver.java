 ...
 * @since 2.0
 */
public abstract class BaseAbstractUnivariateRealSolver<FUNC extends org.apache.commons.math.analysis.UnivariateFunction> implements 
org.apache.commons.math.analysis.solvers.BaseUnivariateRealSolver<FUNC> {
	 ...
	 */ 	protected void setup(int maxEval, FUNC f, double min, double max, double startValue) { 		// Checks.
	...
	/**
	 * {@inheritDoc }
	 */ 	public double solve(int maxEval, FUNC f, double min, double max, double startValue) { 		// Initialization.
	 ...
	 * @param upper
	 * 		Upper endpoint.
	 * @throws org.apache.commons.math.exception.NoBracketingException
	 * 		if
