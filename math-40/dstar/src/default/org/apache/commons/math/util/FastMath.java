...
public class FastMath {
	 ...
	 */ 	/* final */ 	private static boolean LOAD_RESOURCES = false;
	/**
	 * log(2) (high bits).
	 ...
	 */ 	private static final long MASK_30BITS = (-1L) - (org.apache.commons.math.util.FastMath.HEX_40000000 - 1);// 0xFFFFFFFFC0000000L;
	/**
	 ...
	 */ 	private static double doubleHighPart(double d) {
		...
		xl = xl & org.apache.commons.math.util.FastMath.MASK_30BITS;// Drop low order bits
	 ...
	 */ 	public static double acosh(final double a) { 		return org.apache.commons.math.util.FastMath.log(a + org.apache.commons.math.util.FastMath.sqrt((a * a) - 1));}
	 ...
	 */ 	public static double nextUp(final double a) { 		return org.apache.commons.math.util.FastMath.nextAfter(a, java.lang.Double.POSITIVE_INFINITY);}
	 ...
	 * 		number to which neighbor should be computed
	 * @return neighbor of a towards positive infinity
	 */ 	public static float nextUp(final float a) { 		return org.apache.commons.math.util.FastMath.nextAfter(a, java.lang.Float.POSITIVE_INFINITY);}
	 ...
	 */ 	private static double exp(double x, double extra, double[] hiPrec) { 		double intPartA; 		double intPartB; 		int intVal;
		...
		if (x < 0.0) {
			...
			if (intVal > 709) {
				...
				final double result = org.apache.commons.math.util.FastMath.exp(x + 40.19140625, extra, hiPrec) / 2.8504009514401178E17;
				if (hiPrec != null) {
	 ...
	 */ 	private static double log(final double x, final double[] hiPrec) { 		if (x == 0) { 			// Handle special case of +0/-0
		...
		double[] lnm = org.apache.commons.math.util.FastMath.lnMant.LN_MANT[((int) ((bits & 0xffc0000000000L) >> 42))];
		...
		double epsilon = (bits & 0x3ffffffffffL) / (org.apache.commons.math.util.FastMath.TWO_POWER_52 + (bits & 0xffc0000000000L));
	 ...
	 */ 	private static void reducePayneHanek(double x, double[] result) { 		/* Convert input double to bits */
		...
		d = org.apache.commons.math.util.FastMath.PI_O_4_BITS[0] & 0xffffffffL;
		...
		d = org.apache.commons.math.util.FastMath.PI_O_4_BITS[1] & 0xffffffffL;
		ac = a * c;
		bc = b * c;
		ad = a * d;
		...
		/* Convert to double */
		double tmpA = (prod2A >>> 12) / org.apache.commons.math.util.FastMath.TWO_POWER_52;// High order 52 bits
		double tmpB = ((((prod2A & 0xfffL) << 40) + (prod2B >>> 24)) / org.apache.commons.math.util.FastMath.TWO_POWER_52) / org.apache.commons.math.util.FastMath.TWO_POWER_52;// Low bits
	 ...
	 */ 	public static double rint(double x) { 		double y = org.apache.commons.math.util.FastMath.floor(x); 		double d = x - y;
	 ...
	 */ 	public static long round(double x) { 		return ((long) (org.apache.commons.math.util.FastMath.floor(x + 0.5)));}
	 ...
	 */ 	public static int round(final float x) { 		return ((int) (org.apache.commons.math.util.FastMath.floor(x + 0.5F)));}
