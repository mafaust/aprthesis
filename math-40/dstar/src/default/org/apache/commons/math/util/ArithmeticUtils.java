...
public final class ArithmeticUtils {
	 ...
	 * 		long
	 * @since 1.2
	 */ 	public static long addAndCheck(long a, long b) { 		return org.apache.commons.math.util.ArithmeticUtils.addAndCheck(a, b, org.apache.commons.math.exception.util.LocalizedFormats.OVERFLOW_IN_ADDITION);}
	 ...
	 */ 	public static long binomialCoefficient(final int n, final int k) { 		org.apache.commons.math.util.ArithmeticUtils.checkBinomial(n, k); 		if ((n == k) || (k == 0)) { 			return 1;
		}
		if ((k == 1) || (k == (n - 1))) {
			return n;
		}
	 ...
	 * 		if preconditions are not met.
	 */ 	public static double binomialCoefficientDouble(final int n, final int k) { 		org.apache.commons.math.util.ArithmeticUtils.checkBinomial(n, k); 		if ((n == k) || (k == 0)) {
			return 1.0;
		}
		if ((k == 1) || (k == (n - 1))) {
			return n;
	 ...
	 * @throws IllegalArgumentException
	 * 		if preconditions are not met.
	 */ 	public static double binomialCoefficientLog(final int n, final int k) { 		org.apache.commons.math.util.ArithmeticUtils.checkBinomial(n, k); 		if ((n == k) || (k == 0)) {
			return 0;
		}
		if ((k == 1) || (k == (n - 1))) {
	 ...
	 */ 	public static long factorial(final int n) { 		if (n < 0) { 			throw new org.apache.commons.math.exception.NotPositiveException(org.apache.commons.math.exception.util.LocalizedFormats.FACTORIAL_NEGATIVE_PARAMETER, n);
		}
		if (n > 20) {
	 ...
	 * 		a non-negative {@code int} value.
	 * @since 1.1
	 */ 	public static int lcm(int a, int b) { 		if ((a == 0) || (b == 0)) { 			return 0;
		}
	 ...
	 * 		as a {@code long}.
	 * @since 1.2
	 */ 	public static long mulAndCheck(long a, long b) { 		long ret; 		if (a > b) {
	 ...
	 * 		{@code long}.
	 * @since 1.2
	 */ 	public static long subAndCheck(long a, long b) { 		long ret; 		if (b == java.lang.Long.MIN_VALUE) {
			if (a < 0) {
				ret = a - b;
			} else {
	 ...
	 * @throws NotPositiveException
	 * 		if {@code e < 0}.
	 */ 	public static int pow(final int k, int e) { 		if (e < 0) { 			throw new org.apache.commons.math.exception.NotPositiveException(org.apache.commons.math.exception.util.LocalizedFormats.EXPONENT, e);
		}
	 ...
	 * @throws NotPositiveException
	 * 		if {@code e < 0}.
	 */ 	public static int pow(final int k, long e) { 		if (e < 0) { 			throw new org.apache.commons.math.exception.NotPositiveException(org.apache.commons.math.exception.util.LocalizedFormats.EXPONENT, e);
		}
	 ...
	 * @throws NotPositiveException
	 * 		if {@code e < 0}.
	 */ 	public static long pow(final long k, int e) { 		if (e < 0) { 			throw new org.apache.commons.math.exception.NotPositiveException(org.apache.commons.math.exception.util.LocalizedFormats.EXPONENT, e);
		}
	 ...
	 * @throws NotPositiveException
	 * 		if {@code e < 0}.
	 */ 	public static long pow(final long k, long e) { 		if (e < 0) { 			throw new org.apache.commons.math.exception.NotPositiveException(org.apache.commons.math.exception.util.LocalizedFormats.EXPONENT, e);
		}
	 ...
	 * @throws NotPositiveException
	 * 		if {@code e < 0}.
	 */ 	public static java.math.BigInteger pow(final java.math.BigInteger k, int e) { 		if (e < 0) { 			throw new org.apache.commons.math.exception.NotPositiveException(org.apache.commons.math.exception.util.LocalizedFormats.EXPONENT, e);
		}
	 ...
	 * @throws NotPositiveException
	 * 		if {@code e < 0}.
	 */ 	public static java.math.BigInteger pow(final java.math.BigInteger k, long e) { 		if (e < 0) { 			throw new org.apache.commons.math.exception.NotPositiveException(org.apache.commons.math.exception.util.LocalizedFormats.EXPONENT, e);
		}
	 ...
	 * @throws NotPositiveException
	 * 		if {@code e < 0}.
	 */ 	public static java.math.BigInteger pow(final java.math.BigInteger k, java.math.BigInteger e) { 		if (e.compareTo(java.math.BigInteger.ZERO) < 0) { 			throw new org.apache.commons.math.exception.NotPositiveException(org.apache.commons.math.exception.util.LocalizedFormats.EXPONENT, e);
		}
	 ...
	 * 		as a {@code long}.
	 * @since 1.2
	 */ 	private static long addAndCheck(long a, long b, org.apache.commons.math.exception.util.Localizable pattern) { 		long ret; 		if (a > b) { 			// use symmetry to reduce boundary cases
	 ...
	 * 		if {@code k > n}.
	 */ 	private static void checkBinomial(final int n, final int k) { 		if (n < k) { 			throw new org.apache.commons.math.exception.NumberIsTooLargeException(org.apache.commons.math.exception.util.LocalizedFormats.BINOMIAL_INVALID_PARAMETERS_ORDER, k, n, true);
		}
		if (n < 0) {
