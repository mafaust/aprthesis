...
public final class MathUtils {
	 ...
	 * @since 1.2
	 */ 	public static double normalizeAngle(double a, double center) { 		return a - (org.apache.commons.math.util.MathUtils.TWO_PI * org.apache.commons.math.util.FastMath.floor(((a + org.apache.commons.math.util.FastMath.PI) - center) / org.apache.commons.math.util.MathUtils.TWO_PI));}
	 ...
	 * 		and {@code sign >= 0}.
	 */ 	public static byte copySign(byte magnitude, byte sign) { 		if (((magnitude >= 0) && (sign >= 0)) || ((magnitude < 0) && (sign < 0))) { 			// Sign is OK.
			return magnitude;
		} else if ((sign >= 0) && 
	 ...
	 * 		and {@code sign >= 0}.
	 */ 	public static short copySign(short magnitude, short sign) { 		if (((magnitude >= 0) && (sign >= 0)) || ((magnitude < 0) && (sign < 0))) { 			// Sign is OK.
			return magnitude;
		} else if ((sign >= 0) && 
	 ...
	 * 		and {@code sign >= 0}.
	 */ 	public static int copySign(int magnitude, int sign) { 		if (((magnitude >= 0) && (sign >= 0)) || ((magnitude < 0) && (sign < 0))) { 			// Sign is OK.
			return magnitude;
		} else if ((sign >= 0) && 
	 ...
	 * 		and {@code sign >= 0}.
	 */ 	public static long copySign(long magnitude, long sign) { 		if (((magnitude >= 0) && (sign >= 0)) || ((magnitude < 0) && (sign < 0))) { 			// Sign is OK.
			return magnitude;
		} else if ((sign >= 0) && 
	 ...
	 * 		if {@code x} is not a
	 * 		finite real number.
	 */ 	public static void checkFinite(final double x) { 		if (java.lang.Double.isInfinite(x) || java.lang.Double.isNaN(x)) {
	 ...
	 * 		finite real number.
	 */ 	public static void checkFinite(final double[] val) { 		for (int i = 0; i < val.length; i++) {
	 ...
	 */ 	public static void checkNotNull(java.lang.Object o, org.apache.commons.math.exception.util.Localizable pattern, java.lang.Object... args) { 		if (o == null) {
