...
public class FlacocoConfig {
	...
	private void initDefaults() {
		...
		this.testRunnerTimeoutInMs = 1000000; // for the whole execution (16 min)
...
//		this.spectrumFormula = SpectrumFormula.DSTAR;
//		this.spectrumFormula = SpectrumFormula.BARINEL;
//		this.spectrumFormula = SpectrumFormula.JACCARD;
//		this.spectrumFormula = SpectrumFormula.OP2;
//		this.spectrumFormula = SpectrumFormula.TARANTULA;
	}
