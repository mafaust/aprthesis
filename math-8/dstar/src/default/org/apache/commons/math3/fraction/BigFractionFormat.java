...
public class BigFractionFormat extends org.apache.commons.math3.fraction.AbstractFormat implements java.io.Serializable {
	 ...
	 */ 	public static org.apache.commons.math3.fraction.BigFractionFormat getImproperInstance(final java.util.Locale locale) { 		return new org.apache.commons.math3.fraction.BigFractionFormat(org.apache.commons.math3.fraction.AbstractFormat.getDefaultNumberFormat(locale));
	}
	 ...
	 * 		the specific locale used by the format.
	 * @return the complex format specific to the given locale.
	 */ 	public static org.apache.commons.math3.fraction.BigFractionFormat getProperInstance(final java.util.Locale locale) { 		return new org.apache.commons.math3.fraction.ProperBigFractionFormat(org.apache.commons.math3.fraction.AbstractFormat.getDefaultNumberFormat(locale));
	}
	 ...
	 */ 	@java.lang.Override 	public java.lang.StringBuffer format(final java.lang.Object obj, final java.lang.StringBuffer toAppendTo, final java.text.FieldPosition pos) {
		...
		if (obj instanceof org.apache.commons.math3.fraction.BigFraction) {
			...
			ret = format(new org.apache.commons.math3.fraction.BigFraction(((java.lang.Number) (obj)).doubleValue()), 
			toAppendTo, pos);
		} else {
	 ...
	 * 		cannot be parsed.
	 */ 	@java.lang.Override 	public org.apache.commons.math3.fraction.BigFraction parse(final java.lang.String source) throws org.apache.commons.math3.exception.MathParseException { 		final java.text.ParsePosition parsePosition = new java.text.ParsePosition(0);
	 ...
	 * @return the parsed {@link BigFraction} object.
	 */ 	@java.lang.Override 	public org.apache.commons.math3.fraction.BigFraction parse(final java.lang.String source, final java.text.ParsePosition pos) { 		final int initialIndex = pos.getIndex();
