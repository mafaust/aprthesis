 ...
 * @version $Id$
 */
public enum LocalizedFormats implements org.apache.commons.math3.exception.util.Localizable {
	 ...
	 */ 	public java.lang.String getLocalizedString(final java.util.Locale locale) { 		try {
			...
			java.util.ResourceBundle.getBundle("assets/" + path, locale);
			if (bundle.getLocale().getLanguage().equals(locale.getLanguage())) {
				// the value of the resource is the translated format
				return bundle.getString(toString());
			}

		} catch (java.util.MissingResourceException mre) { 			// NOPMD
			// do nothing here
		}
