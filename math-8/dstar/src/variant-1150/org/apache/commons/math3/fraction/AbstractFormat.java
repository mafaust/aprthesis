...
public abstract class AbstractFormat extends java.text.NumberFormat implements java.io.Serializable {
	 ...
	 */ 	public void setDenominatorFormat(final java.text.NumberFormat format) { 		if (format == null) { 			throw new org.apache.commons.math3.exception.NullArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.DENOMINATOR_FORMAT);
		}
	 ...
	 * @throws NullArgumentException
	 * 		if {@code format} is {@code null}.
	 */ 	public void setNumeratorFormat(final java.text.NumberFormat format) { 		if (format == null) { 			throw new org.apache.commons.math3.exception.NullArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.NUMERATOR_FORMAT);
		}
	 ...
	 * 		the string to parse
	 * @param pos
	 * 		input/output parsing parameter.  On output, <code>pos</code>
	 * 		holds the index of the next non-whitespace character.
	 */ 	protected static void parseAndIgnoreWhitespace(final java.lang.String source, final java.text.ParsePosition pos) { 		org.apache.commons.math3.fraction.AbstractFormat.parseNextCharacter(source, pos);
