...
public final class ArithmeticUtils {
	 ...
	 */ 	static final long[] FACTORIALS = new long[]{ 1L, 1L, 2L, 
	6L, 24L, 120L, 
	720L, 5040L, 40320L, 
	 ...
	 * 		as an {@code int}.
	 * @since 1.1
	 */ 	public static int addAndCheck(int x, int y) throws org.apache.commons.math3.exception.MathArithmeticException { 		long s = ((long) (x)) + ((long) (y));
	 ...
	 * 		long
	 * @since 1.2
	 */ 	public static long addAndCheck(long a, long b) throws org.apache.commons.math3.exception.MathArithmeticException { 		return org.apache.commons.math3.util.ArithmeticUtils.addAndCheck(a, b, org.apache.commons.math3.exception.util.LocalizedFormats.OVERFLOW_IN_ADDITION);}
	 ...
	 */ 	public static long binomialCoefficient(final int n, final int k) throws org.apache.commons.math3.exception.NotPositiveException, org.apache.commons.math3.exception.NumberIsTooLargeException, org.apache.commons.math3.exception.MathArithmeticException { 		org.apache.commons.math3.util.ArithmeticUtils.checkBinomial(n, k); 		if ((n == k) || (k == 0)) { 			return 1;
		}
		if ((k == 1) || (k == (n - 1))) {
			return n;
		}
	 ...
	 * 		if the result is too large to be
	 * 		represented by a long integer.
	 */ 	public static double binomialCoefficientDouble(final int n, final int k) throws org.apache.commons.math3.exception.NotPositiveException, org.apache.commons.math3.exception.NumberIsTooLargeException, org.apache.commons.math3.exception.MathArithmeticException { 		org.apache.commons.math3.util.ArithmeticUtils.checkBinomial(n, k); 		if ((n == k) || (k == 0)) { 			return 1.0;
		}
		if ((k == 1) || (k == (n - 1))) {
			return n;
		}
	 ...
	 * 		if the result is too large to be
	 * 		represented by a long integer.
	 */ 	public static double binomialCoefficientLog(final int n, final int k) throws org.apache.commons.math3.exception.NotPositiveException, org.apache.commons.math3.exception.NumberIsTooLargeException, org.apache.commons.math3.exception.MathArithmeticException { 		org.apache.commons.math3.util.ArithmeticUtils.checkBinomial(n, k); 		if ((n == k) || (k == 0)) { 			return 0;
		}
		if ((k == 1) || (k == (n - 1))) {
	 ...
	 */ 	public static long factorial(final int n) throws org.apache.commons.math3.exception.NotPositiveException, org.apache.commons.math3.exception.MathArithmeticException { 		if (n < 0) { 			throw new org.apache.commons.math3.exception.NotPositiveException(org.apache.commons.math3.exception.util.LocalizedFormats.FACTORIAL_NEGATIVE_PARAMETER, n);
		}
		if (n > 20) {
	 ...
	 * @throws NotPositiveException
	 * 		if {@code n < 0}.
	 */ 	public static double factorialDouble(final int n) throws org.apache.commons.math3.exception.NotPositiveException { 		if (n < 0) {
	 ...
	 * @throws NotPositiveException
	 * 		if {@code n < 0}.
	 */ 	public static double factorialLog(final int n) throws org.apache.commons.math3.exception.NotPositiveException { 		if (n < 0) {
			throw new org.apache.commons.math3.exception.NotPositiveException(org.apache.commons.math3.exception.util.LocalizedFormats.FACTORIAL_NEGATIVE_PARAMETER, 
			n);
		}
		if (n < 21) {
	 ...
	 * @since 2.1
	 */ 	public static long gcd(final long p, final long q) throws org.apache.commons.math3.exception.MathArithmeticException { 		long u = p; 		long v = q;
		if ((u == 0) || (v == 0)) {
	 ...
	 * 		a non-negative {@code int} value.
	 * @since 1.1
	 */ 	public static int lcm(int a, int b) throws org.apache.commons.math3.exception.MathArithmeticException { 		if ((a == 0) || (b == 0)) { 			return 0;
		}
	 ...
	 * @since 2.1
	 */ 	public static long lcm(long a, long b) throws org.apache.commons.math3.exception.MathArithmeticException { 		if ((a == 0) || (b == 0)) { 			return 0;
		}
	 ...
	 * @since 1.1
	 */ 	public static int mulAndCheck(int x, int y) throws org.apache.commons.math3.exception.MathArithmeticException { 		long m = ((long) (x)) * ((long) (y)); 		if ((m < java.lang.Integer.MIN_VALUE) || (m > java.lang.Integer.MAX_VALUE)) {
			throw new org.apache.commons.math3.exception.MathArithmeticException();
		}
		return ((int) (m));
	}
	 ...
	 * 		as a {@code long}.
	 * @since 1.2
	 */ 	public static long mulAndCheck(long a, long b) throws org.apache.commons.math3.exception.MathArithmeticException { 		long ret; 		if (a > b) {
	 ...
	 * 		as an {@code int}.
	 * @since 1.1
	 */ 	public static int subAndCheck(int x, int y) throws org.apache.commons.math3.exception.MathArithmeticException { 		long s = ((long) (x)) - ((long) (y)); 		if ((s < java.lang.Integer.MIN_VALUE) || (s > java.lang.Integer.MAX_VALUE)) {
	 ...
	 * 		{@code long}.
	 * @since 1.2
	 */ 	public static long subAndCheck(long a, long b) throws org.apache.commons.math3.exception.MathArithmeticException { 		long ret; 		if (b == java.lang.Long.MIN_VALUE) {
			if (a < 0) {
				ret = a - b;
			} else {
	 ...
	 * @throws NotPositiveException
	 * 		if {@code e < 0}.
	 */ 	public static int pow(final int k, int e) throws org.apache.commons.math3.exception.NotPositiveException { 		if (e < 0) { 			throw new org.apache.commons.math3.exception.NotPositiveException(org.apache.commons.math3.exception.util.LocalizedFormats.EXPONENT, e);
		}
	 ...
	 * @throws NotPositiveException
	 * 		if {@code e < 0}.
	 */ 	public static int pow(final int k, long e) throws org.apache.commons.math3.exception.NotPositiveException { 		if (e < 0) { 			throw new org.apache.commons.math3.exception.NotPositiveException(org.apache.commons.math3.exception.util.LocalizedFormats.EXPONENT, e);
		}
	 ...
	 * @throws NotPositiveException
	 * 		if {@code e < 0}.
	 */ 	public static long pow(final long k, int e) throws org.apache.commons.math3.exception.NotPositiveException { 		if (e < 0) { 			throw new org.apache.commons.math3.exception.NotPositiveException(org.apache.commons.math3.exception.util.LocalizedFormats.EXPONENT, e);
		}
	 ...
	 * @throws NotPositiveException
	 * 		if {@code e < 0}.
	 */ 	public static long pow(final long k, long e) throws org.apache.commons.math3.exception.NotPositiveException { 		if (e < 0) { 			throw new org.apache.commons.math3.exception.NotPositiveException(org.apache.commons.math3.exception.util.LocalizedFormats.EXPONENT, e);
		}
	 ...
	 * @throws NotPositiveException
	 * 		if {@code e < 0}.
	 */ 	public static java.math.BigInteger pow(final java.math.BigInteger k, int e) throws org.apache.commons.math3.exception.NotPositiveException { 		if (e < 0) { 			throw new org.apache.commons.math3.exception.NotPositiveException(org.apache.commons.math3.exception.util.LocalizedFormats.EXPONENT, e);
		}
	 ...
	 * @throws NotPositiveException
	 * 		if {@code e < 0}.
	 */ 	public static java.math.BigInteger pow(final java.math.BigInteger k, long e) throws org.apache.commons.math3.exception.NotPositiveException { 		if (e < 0) { 			throw new org.apache.commons.math3.exception.NotPositiveException(org.apache.commons.math3.exception.util.LocalizedFormats.EXPONENT, e);
		}
	 ...
	 * @throws NotPositiveException
	 * 		if {@code e < 0}.
	 */ 	public static java.math.BigInteger pow(final java.math.BigInteger k, java.math.BigInteger e) throws org.apache.commons.math3.exception.NotPositiveException { 		if (e.compareTo(java.math.BigInteger.ZERO) < 0) { 			throw new org.apache.commons.math3.exception.NotPositiveException(org.apache.commons.math3.exception.util.LocalizedFormats.EXPONENT, e);
		}
	 ...
	 * @since 3.1
	 */ 	public static long stirlingS2(final int n, final int k) throws org.apache.commons.math3.exception.NotPositiveException, org.apache.commons.math3.exception.NumberIsTooLargeException, org.apache.commons.math3.exception.MathArithmeticException { 		if (k < 0) { 			throw new org.apache.commons.math3.exception.NotPositiveException(k);} 		if (k > n) {
	 ...
	 * 		as a {@code long}.
	 * @since 1.2
	 */ 	private static long addAndCheck(long a, long b, org.apache.commons.math3.exception.util.Localizable pattern) throws org.apache.commons.math3.exception.MathArithmeticException { 		long ret; 		if (a > b) { 			// use symmetry to reduce boundary cases
	 ...
	 * @throws NumberIsTooLargeException
	 * 		if {@code k > n}.
	 */ 	private static void checkBinomial(final int n, final int k) throws org.apache.commons.math3.exception.NumberIsTooLargeException, org.apache.commons.math3.exception.NotPositiveException { 		if (n < k) { 			throw new org.apache.commons.math3.exception.NumberIsTooLargeException(org.apache.commons.math3.exception.util.LocalizedFormats.BINOMIAL_INVALID_PARAMETERS_ORDER, k, n, true);
		}
		if (n < 0) {
