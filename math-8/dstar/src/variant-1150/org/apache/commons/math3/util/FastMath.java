...
public class FastMath { 	/**
	 ...
	 * 		number from which absolute value is requested
	 * @return abs(x)
	 */ 	public static long abs(final long x) { 		return x < 0L ? -x : x;
	}
	 ...
	 * 		number from which absolute value is requested
	 * @return abs(x)
	 */ 	public static float abs(final float x) { 		return x < 0.0F ? -x : x == 0.0F ? 0.0F : x;// -0.0 => +0.0
	}
	 ...
	 * 		number from which absolute value is requested
	 * @return abs(x)
	 */ 	public static double abs(double x) { 		return x < 0.0 ? -x : x == 0.0 ? 0.0 : x;// -0.0 => +0.0
	}
	 ...
	 */ 	public static double copySign(double magnitude, double sign) { 		long m = java.lang.Double.doubleToLongBits(magnitude);
	 ...
	 * 		the sign for the returned value
	 * @return the magnitude with the same sign as the {@code sign} argument
	 */ 	public static float copySign(float magnitude, float sign) { 		int m = java.lang.Float.floatToIntBits(magnitude);
	 ...
	 */ 	public static int getExponent(final double d) { 		return ((int) ((java.lang.Double.doubleToLongBits(d) >>> 52) & 0x7ff)) - 1023;
	}
	 ...
	 * 		number from which exponent is requested
	 * @return exponent for d in IEEE754 representation, without bias
	 */ 	public static int getExponent(final float f) { 		return ((java.lang.Float.floatToIntBits(f) >>> 23) & 0xff) - 127;
	}
