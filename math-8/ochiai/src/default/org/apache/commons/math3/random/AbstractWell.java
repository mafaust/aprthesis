...
public abstract class AbstractWell extends org.apache.commons.math3.random.BitsStreamGenerator implements java.io.Serializable {
	 ...
	 * @param seed
	 * 		the initial seed (32 bits integer)
	 */ 	@java.lang.Override 	public void setSeed(final int seed) { 		setSeed(new int[]{ seed });}
	/**
	 ...
	 */ 	@java.lang.Override 	public void setSeed(final int[] seed) { 		if (seed == null) {
			setSeed(java.lang.System.currentTimeMillis() + java.lang.System.identityHashCode(this));
			return;
		}
	 ...
	 * @param seed
	 * 		the initial seed (64 bits integer)
	 */ 	@java.lang.Override 	public void setSeed(final long seed) { 		setSeed(new int[]{ ((int) (seed >>> 32)), ((int) (seed & 0xffffffffL)) });
	}

	/**
	 * {@inheritDoc }
	 */ 	@java.lang.Override 	protected abstract int next(final int bits);}