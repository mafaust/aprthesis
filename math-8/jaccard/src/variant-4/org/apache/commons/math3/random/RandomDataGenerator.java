...
public class RandomDataGenerator implements org.apache.commons.math3.random.RandomData , java.io.Serializable {
	...
	/**
	 * {@inheritDoc }
	 */ 	public int nextInt(int lower, int upper) throws org.apache.commons.math3.exception.NumberIsTooLargeException { 		if (lower >= upper) {
	...
	/**
	 * {@inheritDoc }
	 */ 	public long nextLong(long lower, long upper) throws org.apache.commons.math3.exception.NumberIsTooLargeException { 		if (lower >= upper) {
			throw new org.apache.commons.math3.exception.NumberIsTooLargeException(org.apache.commons.math3.exception.util.LocalizedFormats.LOWER_BOUND_NOT_BELOW_UPPER_BOUND, 
			lower, upper, false);
		}
		double r = getRan().nextDouble();
	...
	/**
	 * {@inheritDoc }
	 */ 	public int nextSecureInt(int lower, int upper) throws org.apache.commons.math3.exception.NumberIsTooLargeException { 		if (lower >= upper) {
			throw new org.apache.commons.math3.exception.NumberIsTooLargeException(org.apache.commons.math3.exception.util.LocalizedFormats.LOWER_BOUND_NOT_BELOW_UPPER_BOUND, 
			lower, upper, false);
		}
	...
	/**
	 * {@inheritDoc }
	 */ 	public long nextSecureLong(long lower, long upper) throws org.apache.commons.math3.exception.NumberIsTooLargeException { 		if (lower >= upper) {
			throw new org.apache.commons.math3.exception.NumberIsTooLargeException(org.apache.commons.math3.exception.util.LocalizedFormats.LOWER_BOUND_NOT_BELOW_UPPER_BOUND, 
			lower, upper, false);
		}
		java.security.SecureRandom sec = getSecRan();
	 ...
	 * @throws NotStrictlyPositiveException
	 * 		if {@code len <= 0}
	 */ 	public long nextPoisson(double mean) throws org.apache.commons.math3.exception.NotStrictlyPositiveException { 		return new org.apache.commons.math3.distribution.PoissonDistribution(getRan(), mean, 
	...
	public double nextExponential(double mean) throws org.apache.commons.math3.exception.NotStrictlyPositiveException {
		return new org.apache.commons.math3.distribution.ExponentialDistribution(getRan(), mean, 
	 ...
	 * 		range {@code [0, 1]}.
	 */ 	public int nextPascal(int r, double p) throws org.apache.commons.math3.exception.NotStrictlyPositiveException, org.apache.commons.math3.exception.OutOfRangeException { 		return new org.apache.commons.math3.distribution.PascalDistribution(getRan(), r, p).sample();}
	/**
	 ...
	 * @throws NotStrictlyPositiveException
	 * 		if {@code df <= 0}
	 */ 	public double nextT(double df) throws org.apache.commons.math3.exception.NotStrictlyPositiveException { 		return new org.apache.commons.math3.distribution.TDistribution(getRan(), df, 
	 ...
	 * 		or {@code exponent <= 0}.
	 */ 	public int nextZipf(int numberOfElements, double exponent) throws org.apache.commons.math3.exception.NotStrictlyPositiveException { 		return new org.apache.commons.math3.distribution.ZipfDistribution(getRan(), numberOfElements, exponent).sample();}
	 ...
	 */ 	public double nextBeta(double alpha, double beta) { 		return new org.apache.commons.math3.distribution.BetaDistribution(getRan(), alpha, beta, 
	 ...
	 */ 	public int nextBinomial(int numberOfTrials, double probabilityOfSuccess) { 		return new org.apache.commons.math3.distribution.BinomialDistribution(getRan(), numberOfTrials, probabilityOfSuccess).sample();
	}
	 ...
	 */ 	public double nextCauchy(double median, double scale) { 		return new org.apache.commons.math3.distribution.CauchyDistribution(getRan(), median, scale, 
	 ...
	 */ 	public double nextChiSquare(double df) {
		return new org.apache.commons.math3.distribution.ChiSquaredDistribution(getRan(), df, 
	 ...
	 */ 	public double nextF(double numeratorDf, double denominatorDf) throws org.apache.commons.math3.exception.NotStrictlyPositiveException { 		return new org.apache.commons.math3.distribution.FDistribution(getRan(), numeratorDf, denominatorDf, org.apache.commons.math3.distribution.FDistribution.DEFAULT_INVERSE_ABSOLUTE_ACCURACY).sample();
	}
	 ...
	 */
	public void reSeed() {
		getRan().setSeed(java.lang.System.currentTimeMillis() + java.lang.System.identityHashCode(this));
	}
	 ...
	 */ 	public void setSecureAlgorithm(java.lang.String algorithm, java.lang.String provider) throws java.security.NoSuchAlgorithmException, java.security.NoSuchProviderException { 		secRand = java.security.SecureRandom.getInstance(algorithm, provider);}
