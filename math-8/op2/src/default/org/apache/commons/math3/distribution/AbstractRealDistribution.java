 ...
 * @since 3.0
 */
public abstract class AbstractRealDistribution implements 
org.apache.commons.math3.distribution.RealDistribution , java.io.Serializable {
	/**
	 * Default accuracy.
	 ...
	 */ 	@java.lang.Deprecated 	protected AbstractRealDistribution() {
	 ...
	 * @since 3.1
	 */ 	protected AbstractRealDistribution(org.apache.commons.math3.random.RandomGenerator rng) { 		random = rng;}
	...
	public double inverseCumulativeProbability(final double p) throws org.apache.commons.math3.exception.OutOfRangeException {
		...
		chebyshevApplies = !(((java.lang.Double.isInfinite(mu) || java.lang.Double.isNaN(mu)) || 
		java.lang.Double.isInfinite(sig)) || java.lang.Double.isNaN(sig));
		...
		double x = org.apache.commons.math3.analysis.solvers.UnivariateSolverUtils.solve(toSolve, 
		lowerBound, 
		upperBound, 
