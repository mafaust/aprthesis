...
public class RealPointValuePair implements java.io.Serializable {
	 ...
	 */ 	public RealPointValuePair(final double[] point, final double value) { 		this.point = point.clone(); 		this.value = value;}
	 ...
	 */ 	public RealPointValuePair(final double[] point, final double value, final boolean copyArray) { 		this.point = (copyArray) ? point.clone() : point; 		this.value = value;}

	/**
	 * Get the point.
	 *
	 * @return a copy of the stored point
	 */ 	public double[] getPoint() { 		return point.clone();
	}
