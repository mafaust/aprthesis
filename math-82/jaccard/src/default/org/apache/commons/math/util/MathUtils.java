...
public final class MathUtils {
	 ...
	 */ 	private static final long[] factorials = new long[]{ 1, 1, 2, 6, 24, 120, 720, 5040, 40320, 362880, 3628800, 39916800, 
	 ...
	 * 		value
	 * @since 1.1
	 */ 	public static int gcd(final int p, final int q) { 		int u = p;
		int v = q;
		if ((u == 0) || (v == 0)) {
	 ...
	 */ 	public static final double distance1(double[] p1, double[] p2) { 		double sum = 0;
	 ...
	 * 		the second point
	 * @return the L<sub>1</sub> distance between the two points
	 */ 	public static final int distance1(int[] p1, int[] p2) { 		int sum = 0;
		for (int i = 0; i < p1.length; i++) {
			sum += java.lang.Math.abs(p1[i] - p2[i]);
		}
		return sum;
	 ...
	 */ 	public static final double distance(double[] p1, double[] p2) { 		double sum = 0;
		for (int i = 0; i < p1.length; i++) {
	 ...
	 * 		the second point
	 * @return the L<sub>2</sub> distance between the two points
	 */ 	public static final double distance(int[] p1, int[] p2) { 		int sum = 0;
		for (int i = 0; i < p1.length; i++) {
	 ...
	 */ 	public static final double distanceInf(double[] p1, double[] p2) { 		double max = 0;
		for (int i = 0; i < p1.length; i++) {
	 ...
	 * 		the second point
	 * @return the L<sub>&infin;</sub> distance between the two points
	 */ 	public static final int distanceInf(int[] p1, int[] p2) { 		int max = 0;
		for (int i = 0; i < p1.length; i++) {
			max = java.lang.Math.max(max, java.lang.Math.abs(p1[i] - p2[i]));
		}
		return max;
