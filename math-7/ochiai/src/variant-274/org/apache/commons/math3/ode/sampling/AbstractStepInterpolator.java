...
org.apache.commons.math3.ode.sampling.StepInterpolator {
	 ...
	 * some cases. As an example, the {@link org.apache.commons.math3.ode.nonstiff.EmbeddedRungeKuttaIntegrator}
	 ...
	 * 		equations mappers for the secondary equations sets
	 */ 	protected AbstractStepInterpolator(final double[] y, final boolean forward, final org.apache.commons.math3.ode.EquationsMapper primaryMapper, final org.apache.commons.math3.ode.EquationsMapper[] secondaryMappers) { 		globalPreviousTime = java.lang.Double.NaN; 		globalCurrentTime = java.lang.Double.NaN;
		softPreviousTime = java.lang.Double.NaN;
		softCurrentTime = java.lang.Double.NaN;
		h = java.lang.Double.NaN;
		interpolatedTime = java.lang.Double.NaN;
	 ...
	 * @param secondary
	 * 		equations mappers for the secondary equations sets
	 */ 	protected void reinitialize(final double[] y, final boolean isForward, final org.apache.commons.math3.ode.EquationsMapper primary, final org.apache.commons.math3.ode.EquationsMapper[] secondary) { 		globalPreviousTime = java.lang.Double.NaN; 		globalCurrentTime = java.lang.Double.NaN;
		softPreviousTime = java.lang.Double.NaN;
		softCurrentTime = java.lang.Double.NaN;
		h = java.lang.Double.NaN;
		interpolatedTime = java.lang.Double.NaN;
	 ...
	 * @param t
	 * 		current time
	 */ 	public void storeTime(final double t) { 		globalCurrentTime = t;
		softCurrentTime = globalCurrentTime;
	 ...
	 * @exception MaxCountExceededException
	 * 		if the number of functions evaluations is exceeded
	 */ 	private void evaluateCompleteInterpolatedState() throws org.apache.commons.math3.exception.MaxCountExceededException { 		// lazy evaluation of the state
		if (dirtyState) {
	...
	/**
	 * {@inheritDoc }
	 */ 	public double[] getInterpolatedState() throws org.apache.commons.math3.exception.MaxCountExceededException { 		evaluateCompleteInterpolatedState();
	...
	/**
	 * {@inheritDoc }
	 */ 	public double[] getInterpolatedDerivatives() throws org.apache.commons.math3.exception.MaxCountExceededException { 		evaluateCompleteInterpolatedState();
	...
	/**
	 * {@inheritDoc }
	 */ 	public double[] getInterpolatedSecondaryState(final int index) throws org.apache.commons.math3.exception.MaxCountExceededException { 		evaluateCompleteInterpolatedState();
	...
	/**
	 * {@inheritDoc }
	 */ 	public double[] getInterpolatedSecondaryDerivatives(final int index) throws org.apache.commons.math3.exception.MaxCountExceededException { 		evaluateCompleteInterpolatedState();
	 ...
	 * 		cannot be found
	 */ 	protected double readBaseExternal(final java.io.ObjectInput in) throws java.io.IOException, java.lang.ClassNotFoundException { 		final int dimension = in.readInt(); 		globalPreviousTime = in.readDouble();
