...
public abstract class AbstractIntegrator implements org.apache.commons.math3.ode.FirstOrderIntegrator {
	 ...
	 * @param name
	 * 		name of the method
	 */ 	public AbstractIntegrator(final java.lang.String name) { 		this.name = name; 		stepHandlers = new java.util.ArrayList<org.apache.commons.math3.ode.sampling.StepHandler>();
	 ...
	 */ 	protected void initIntegration(final double t0, final double[] y0, final double t) { 		evaluations.resetCount(); 		for (final org.apache.commons.math3.ode.events.EventState state : eventsStates) {
	 ...
	 * @param equations
	 * 		equations to set
	 */ 	protected void setEquations(final org.apache.commons.math3.ode.ExpandableStatefulODE equations) { 		this.expandable = equations;}

	/**
	 * {@inheritDoc }
	 */ 	public double integrate(final org.apache.commons.math3.ode.FirstOrderDifferentialEquations equations, final double t0, final double[] y0, final double t, final double[] y) throws 
	 ...
	 */ 	public void computeDerivatives(final double t, final double[] y, final double[] yDot) throws org.apache.commons.math3.exception.MaxCountExceededException, org.apache.commons.math3.exception.DimensionMismatchException { 		evaluations.incrementCount(); 		expandable.computeDerivatives(t, y, yDot);} 	/**
	 ...
	 * 		if arrays dimensions do not match equations settings
	 * @since 2.2
	 */ 	protected double acceptStep(final org.apache.commons.math3.ode.sampling.AbstractStepInterpolator interpolator, final double[] y, final double[] yDot, final double tEnd) throws org.apache.commons.math3.exception.MaxCountExceededException, org.apache.commons.math3.exception.DimensionMismatchException, org.apache.commons.math3.exception.NoBracketingException { 		double previousT = interpolator.getGlobalPreviousTime(); 		final double currentT = interpolator.getGlobalCurrentTime(); 		// initialize the events states if needed
		if (!statesInitialized) { 			for (org.apache.commons.math3.ode.events.EventState state : eventsStates) {
		...
		java.util.SortedSet<org.apache.commons.math3.ode.events.EventState> occuringEvents = new java.util.TreeSet<org.apache.commons.math3.ode.events.EventState>(new java.util.Comparator<org.apache.commons.math3.ode.events.EventState>() {
			...
			/**
			 * {@inheritDoc }
			 */ 			public int compare(org.apache.commons.math3.ode.events.EventState es0, org.apache.commons.math3.ode.events.EventState es1) { 				return orderingSign * java.lang.Double.compare(es0.getEventTime(), es1.getEventTime());
			}
	 ...
	 */ 	protected void sanityChecks(final org.apache.commons.math3.ode.ExpandableStatefulODE equations, final double t) throws org.apache.commons.math3.exception.NumberIsTooSmallException, org.apache.commons.math3.exception.DimensionMismatchException { 		final double threshold = 1000 * org.apache.commons.math3.util.FastMath.ulp(org.apache.commons.math3.util.FastMath.max(org.apache.commons.math3.util.FastMath.abs(equations.getTime()), org.apache.commons.math3.util.FastMath.abs(t))); 		final double dt = org.apache.commons.math3.util.FastMath.abs(equations.getTime() - t);
		if (dt <= threshold) {
			throw new org.apache.commons.math3.exception.NumberIsTooSmallException(org.apache.commons.math3.exception.util.LocalizedFormats.TOO_SMALL_INTEGRATION_INTERVAL, 
			dt, threshold, false);
		}
