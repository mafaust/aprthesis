...
public class Incrementor {
	 ...
	 */ 	public Incrementor(int max) {
		...
		new org.apache.commons.math3.util.Incrementor.MaxCountExceededCallback() {
			/**
			 * {@inheritDoc }
			 */ 			public void trigger(int max) throws org.apache.commons.math3.exception.MaxCountExceededException { 				throw new org.apache.commons.math3.exception.MaxCountExceededException(max);
			}
		});
	}
	 ...
	 */ 	public Incrementor(int max, org.apache.commons.math3.util.Incrementor.MaxCountExceededCallback cb) throws org.apache.commons.math3.exception.NullArgumentException { 		if (cb == null) {
	 ...
	 */ 	public void incrementCount(int value) throws org.apache.commons.math3.exception.MaxCountExceededException { 		for (int i = 0; i < value; i++) {
			incrementCount();
		}
	}
