...
public class UnivariateSolverUtils {
	 ...
	 */ 	public static double solve(org.apache.commons.math3.analysis.UnivariateFunction function, double x0, double x1) throws org.apache.commons.math3.exception.NullArgumentException, org.apache.commons.math3.exception.NoBracketingException { 		if (function == null) { 			throw new org.apache.commons.math3.exception.NullArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.FUNCTION);
		}
	 ...
	 * @throws NullArgumentException
	 * 		if {@code function} is {@code null}.
	 */ 	public static double solve(org.apache.commons.math3.analysis.UnivariateFunction function, double x0, double x1, double absoluteAccuracy) throws org.apache.commons.math3.exception.NullArgumentException, org.apache.commons.math3.exception.NoBracketingException { 		if (function == null) {
	 ...
	 * 		if the function has the same sign at the
	 * 		endpoints.
	 */ 	public static double forceSide(final int maxEval, final org.apache.commons.math3.analysis.UnivariateFunction f, final org.apache.commons.math3.analysis.solvers.BracketedUnivariateSolver<org.apache.commons.math3.analysis.UnivariateFunction> bracketing, final double baseRoot, final double min, final double max, final org.apache.commons.math3.analysis.solvers.AllowedSolution allowedSolution) throws org.apache.commons.math3.exception.NoBracketingException { 		if (allowedSolution == org.apache.commons.math3.analysis.solvers.AllowedSolution.ANY_SIDE) { 			// no further bracketing required
			return baseRoot;}
		// find a very small interval bracketing the root
		final double step = org.apache.commons.math3.util.FastMath.max(bracketing.getAbsoluteAccuracy(), 
		org.apache.commons.math3.util.FastMath.abs(baseRoot * bracketing.getRelativeAccuracy()));
		...
		throw new org.apache.commons.math3.exception.NoBracketingException(org.apache.commons.math3.exception.util.LocalizedFormats.FAILED_BRACKETING, 
		xLo, xHi, fLo, fHi, 
	 ...
	 * @throws NullArgumentException
	 * 		if {@code function} is {@code null}.
	 */ 	public static double[] bracket(org.apache.commons.math3.analysis.UnivariateFunction function, double initial, double lowerBound, double upperBound) throws org.apache.commons.math3.exception.NullArgumentException, org.apache.commons.math3.exception.NotStrictlyPositiveException, org.apache.commons.math3.exception.NoBracketingException { 		return org.apache.commons.math3.analysis.solvers.UnivariateSolverUtils.bracket(function, initial, lowerBound, upperBound, java.lang.Integer.MAX_VALUE);
	}
	 ...
	 * @throws NullArgumentException
	 * 		if {@code function} is {@code null}.
	 */ 	public static double[] bracket(org.apache.commons.math3.analysis.UnivariateFunction function, double initial, double lowerBound, double upperBound, int maximumIterations) throws org.apache.commons.math3.exception.NullArgumentException, org.apache.commons.math3.exception.NotStrictlyPositiveException, org.apache.commons.math3.exception.NoBracketingException { 		if (function == null) {
			throw new org.apache.commons.math3.exception.NullArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.FUNCTION);
		}
	 ...
	 */ 	public static void verifyInterval(final double lower, final double upper) throws org.apache.commons.math3.exception.NumberIsTooLargeException {
		if (lower >= upper) {
			throw new org.apache.commons.math3.exception.NumberIsTooLargeException(org.apache.commons.math3.exception.util.LocalizedFormats.ENDPOINTS_NOT_AN_INTERVAL, 
			lower, upper, false);
		}
	}
	 ...
	 * @throws NullArgumentException
	 * 		if {@code function} is {@code null}.
	 */ 	public static void verifyBracketing(org.apache.commons.math3.analysis.UnivariateFunction function, final double lower, final double upper) throws org.apache.commons.math3.exception.NullArgumentException, org.apache.commons.math3.exception.NoBracketingException {
		if (function == null) {
			throw new org.apache.commons.math3.exception.NullArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.FUNCTION);
		}
		...
		if (!org.apache.commons.math3.analysis.solvers.UnivariateSolverUtils.isBracketing(function, lower, upper)) {
			throw new org.apache.commons.math3.exception.NoBracketingException(lower, upper, 
