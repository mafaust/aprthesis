 ...
 * @version $Id$
 */
public abstract class BaseAbstractUnivariateSolver<FUNC extends org.apache.commons.math3.analysis.UnivariateFunction> implements 
org.apache.commons.math3.analysis.solvers.BaseUnivariateSolver<FUNC> {
	 ...
	 */ 	protected BaseAbstractUnivariateSolver(final double absoluteAccuracy) {
		this(org.apache.commons.math3.analysis.solvers.BaseAbstractUnivariateSolver.DEFAULT_RELATIVE_ACCURACY, 
		absoluteAccuracy, 
		org.apache.commons.math3.analysis.solvers.BaseAbstractUnivariateSolver.DEFAULT_FUNCTION_VALUE_ACCURACY);
	}
	 ...
	 * 		if f is null
	 */ 	protected void setup(int maxEval, FUNC f, double min, double max, double startValue) throws org.apache.commons.math3.exception.NullArgumentException { 		// Checks.
	...
	/**
	 * {@inheritDoc }
	 */ 	public double solve(int maxEval, FUNC f, double min, double max, double startValue) throws org.apache.commons.math3.exception.TooManyEvaluationsException, 
	...
	/**
	 * {@inheritDoc }
	 */ 	public double solve(int maxEval, FUNC f, double startValue) throws org.apache.commons.math3.exception.TooManyEvaluationsException, 
	org.apache.commons.math3.exception.NoBracketingException {
	 ...
	 */ 	protected void incrementEvaluationCount() throws 
