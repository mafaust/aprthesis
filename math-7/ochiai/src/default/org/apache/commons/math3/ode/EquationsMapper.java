...
public class EquationsMapper implements java.io.Serializable {
	 ...
	 * @param dimension
	 * 		dimension of the secondary state parameters
	 */ 	public EquationsMapper(final int firstIndex, final int dimension) { 		this.firstIndex = firstIndex; 		this.dimension = dimension;}
	 ...
	 */ 	public void extractEquationData(double[] complete, double[] equationData) throws org.apache.commons.math3.exception.DimensionMismatchException { 		if (equationData.length != dimension) { 			throw new org.apache.commons.math3.exception.DimensionMismatchException(equationData.length, dimension);}
	 ...
	 * 		if the dimension of the equation data does not
	 * 		match the mapper dimension
	 */ 	public void insertEquationData(double[] equationData, double[] complete) throws org.apache.commons.math3.exception.DimensionMismatchException { 		if (equationData.length != dimension) { 			throw new org.apache.commons.math3.exception.DimensionMismatchException(equationData.length, dimension);}
