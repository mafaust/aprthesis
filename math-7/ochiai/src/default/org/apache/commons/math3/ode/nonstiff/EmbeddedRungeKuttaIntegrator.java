...
org.apache.commons.math3.ode.nonstiff.AdaptiveStepsizeIntegrator {
	 ...
	 */ 	protected EmbeddedRungeKuttaIntegrator(final java.lang.String name, final boolean fsal, final double[] c, final double[][] a, final double[] b, final org.apache.commons.math3.ode.nonstiff.RungeKuttaStepInterpolator prototype, final double minStep, final double maxStep, final double scalAbsoluteTolerance, final double scalRelativeTolerance) { 		super(name, minStep, maxStep, scalAbsoluteTolerance, scalRelativeTolerance); 		this.fsal = fsal; 		this.c = c; 		this.a = a;
		this.b = b;
	 ...
	 * 		allowed relative error
	 */ 	protected EmbeddedRungeKuttaIntegrator(final java.lang.String name, final boolean fsal, final double[] c, final double[][] a, final double[] b, final org.apache.commons.math3.ode.nonstiff.RungeKuttaStepInterpolator prototype, final double minStep, final double maxStep, final double[] vecAbsoluteTolerance, final double[] vecRelativeTolerance) { 		super(name, minStep, maxStep, vecAbsoluteTolerance, vecRelativeTolerance); 		this.fsal = fsal; 		this.c = c; 		this.a = a;
		this.b = b;
		this.prototype = prototype;
	...
	/**
	 * {@inheritDoc }
	 */ 	@java.lang.Override 	public void integrate(final org.apache.commons.math3.ode.ExpandableStatefulODE equations, final double t) throws 
		...
		do {
			...
			while (error >= 1.0) {
				...
				if (error >= 1.0) {
					...
					final double factor = 
					org.apache.commons.math3.util.FastMath.min(maxGrowth, 
					org.apache.commons.math3.util.FastMath.max(minReduction, safety * org.apache.commons.math3.util.FastMath.pow(error, exp)));
			...
			if (!isLastStep) {
				...
				final double factor = 
				org.apache.commons.math3.util.FastMath.min(maxGrowth, org.apache.commons.math3.util.FastMath.max(minReduction, safety * org.apache.commons.math3.util.FastMath.pow(error, exp)));
