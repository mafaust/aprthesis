 ...
 * {@link #setStartConfiguration(double[])} or {@link #setStartConfiguration(double[][])}. If neither method has been called
 ...
 * configuration from a unit hypercube. Each call to {@link #optimize(MultivariateRealFunction, GoalType, double[]) optimize} will reuse
 ...
 * @since 1.2
 */
public abstract class DirectSearchOptimizer implements 
...
org.apache.commons.math.optimization.MultivariateRealOptimizer {
	 ...
	 * 		if one step is null
	 */ 	public void setStartConfiguration(final double[] steps) throws java.lang.IllegalArgumentException { 		// only the relative position of the n final vertices with respect 		// to the first one are stored
	 ...
	 */ 	public void setStartConfiguration(final double[][] referenceSimplex) throws java.lang.IllegalArgumentException { 		// only the relative position of the n final vertices with respect
