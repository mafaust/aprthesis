...
org.apache.commons.math.distribution.FDistribution , java.io.Serializable {
	 ...
	 */ 	public FDistributionImpl(double numeratorDegreesOfFreedom, double denominatorDegreesOfFreedom) { 		super();
	 ...
	 * 		probability.
	 */ 	public double inverseCumulativeProbability(final double p) throws org.apache.commons.math.MathException { 		if (p == 0) {
			return 0.0;
		}
		if (p == 1) {
