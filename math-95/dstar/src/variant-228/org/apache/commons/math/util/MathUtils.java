...
public final class MathUtils {
	 ...
	 * 		long
	 * @since 1.2
	 */ 	private static long addAndCheck(long a, long b, java.lang.String msg) { 		long ret; 		if (a > b) { 			// use symmetry to reduce boundry cases
	 ...
	 * 		by a long integer.
	 */ 	public static long binomialCoefficient(final int n, final int k) { 		if (n < k) { 			throw new java.lang.IllegalArgumentException("must have n >= k for binomial coefficient (n,k)");
		}
		if (n < 0) {
	 ...
	 * @throws IllegalArgumentException
	 * 		if preconditions are not met.
	 */ 	public static double binomialCoefficientDouble(final int n, final int k) { 		return java.lang.Math.floor(java.lang.Math.exp(org.apache.commons.math.util.MathUtils.binomialCoefficientLog(n, k)) + 0.5);}
	 ...
	 * @throws IllegalArgumentException
	 * 		if preconditions are not met.
	 */ 	public static double binomialCoefficientLog(final int n, final int k) { 		if (n < k) { 			throw new java.lang.IllegalArgumentException(
	 ...
	 * @throws IllegalArgumentException
	 * 		if n < 0
	 */ 	public static long factorial(final int n) { 		long result = java.lang.Math.round(org.apache.commons.math.util.MathUtils.factorialDouble(n)); 		if (result == java.lang.Long.MAX_VALUE) {
			throw new java.lang.ArithmeticException(
			"result too large to represent in a long integer");
		}
		return result;
	 ...
	 * @since 1.1
	 */ 	public static int gcd(int u, int v) { 		if ((u * v) == 0) {
	 ...
	 * @since 1.1
	 */ 	public static int lcm(int a, int b) { 		return java.lang.Math.abs(org.apache.commons.math.util.MathUtils.mulAndCheck(a / org.apache.commons.math.util.MathUtils.gcd(a, b), b));}
