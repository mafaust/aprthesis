...
public class FractionFormat extends java.text.Format implements java.io.Serializable {
	 ...
	 */ 	public FractionFormat(java.text.NumberFormat format) { 		this(format, ((java.text.NumberFormat) (format.clone())));
	}
	 ...
	 */ 	public static org.apache.commons.math.fraction.FractionFormat getImproperInstance(java.util.Locale locale) { 		java.text.NumberFormat f = org.apache.commons.math.fraction.FractionFormat.getDefaultNumberFormat(locale);
	 ...
	 * 		the specific locale used by the format.
	 * @return the complex format specific to the given locale.
	 */ 	public static org.apache.commons.math.fraction.FractionFormat getProperInstance(java.util.Locale locale) { 		java.text.NumberFormat f = org.apache.commons.math.fraction.FractionFormat.getDefaultNumberFormat(locale);
	 ...
	 */ 	private static java.text.NumberFormat getDefaultNumberFormat(java.util.Locale locale) { 		java.text.NumberFormat nf = java.text.NumberFormat.getNumberInstance(locale);
	 ...
	 */ 	public java.lang.StringBuffer format(java.lang.Object obj, java.lang.StringBuffer toAppendTo, java.text.FieldPosition pos) { 		java.lang.StringBuffer ret = null;
	 ...
	 * 		cannot be parsed.
	 */ 	public org.apache.commons.math.fraction.Fraction parse(java.lang.String source) throws java.text.ParseException { 		java.text.ParsePosition parsePosition = new java.text.ParsePosition(0); 		org.apache.commons.math.fraction.Fraction result = parse(source, parsePosition);
		if (parsePosition.getIndex() == 0) {
			throw new java.text.ParseException(("Unparseable fraction number: \"" + 
	 ...
	 * @return the parsed {@link Fraction} object.
	 */ 	public org.apache.commons.math.fraction.Fraction parse(java.lang.String source, java.text.ParsePosition pos) { 		int initialIndex = pos.getIndex();
		// parse whitespace
