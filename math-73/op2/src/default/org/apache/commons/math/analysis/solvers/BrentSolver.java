...
public class BrentSolver extends org.apache.commons.math.analysis.solvers.UnivariateRealSolverImpl {
	 ...
	 */ 	private static final java.lang.String NON_BRACKETING_MESSAGE = "function values at endpoints do not have different signs.  " + 
	 ...
	 */ 	public double solve(final org.apache.commons.math.analysis.UnivariateRealFunction f, final double min, final double max, final double initial) throws org.apache.commons.math.MaxIterationsExceededException, org.apache.commons.math.FunctionEvaluationException { 		clearResult(); 		verifySequence(min, initial, max);
	 ...
	 */ 	public double solve(final org.apache.commons.math.analysis.UnivariateRealFunction f, final double min, final double max) throws org.apache.commons.math.MaxIterationsExceededException, org.apache.commons.math.FunctionEvaluationException { 		clearResult();
		...
		if (sign > 0) {
			...
			if (java.lang.Math.abs(yMin) <= functionValueAccuracy) {
				...
				org.apache.commons.math.analysis.solvers.BrentSolver.NON_BRACKETING_MESSAGE, min, max, yMin, yMax);
			}
		} else if (sign < 0) {
