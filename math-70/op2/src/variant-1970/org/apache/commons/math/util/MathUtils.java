...
public final class MathUtils {
	 ...
	 * 		if preconditions are not met.
	 */ 	private static void checkBinomial(final int n, final int k) throws java.lang.IllegalArgumentException { 		if (n < k) { 			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
	 ...
	 */ 	private static double roundUnscaled(double unscaled, double sign, int roundingMethod) { 		switch (roundingMethod) {
			...
			case java.math.BigDecimal.ROUND_HALF_EVEN : 				{
					...
					if ((java.lang.Math.floor(unscaled) / 2.0) == java.lang.Math.floor(java.lang.Math.floor(
					unscaled) / 2.0)) { 						// even
						unscaled = java.lang.Math.floor(unscaled);
					} else { 						// odd
						unscaled = java.lang.Math.ceil(unscaled);
	 ...
	 * @exception IllegalArgumentException
	 * 		if e is negative
	 */ 	public static int pow(final int k, int e) throws java.lang.IllegalArgumentException { 		if (e < 0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
	 ...
	 * @exception IllegalArgumentException
	 * 		if e is negative
	 */ 	public static int pow(final int k, long e) throws java.lang.IllegalArgumentException { 		if (e < 0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
			"cannot raise an integral value to a negative power ({0}^{1})", 
			k, e);
		}
	 ...
	 * @exception IllegalArgumentException
	 * 		if e is negative
	 */ 	public static long pow(final long k, int e) throws java.lang.IllegalArgumentException { 		if (e < 0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
			"cannot raise an integral value to a negative power ({0}^{1})", 
			k, e);
		}
	 ...
	 * @exception IllegalArgumentException
	 * 		if e is negative
	 */ 	public static long pow(final long k, long e) throws java.lang.IllegalArgumentException { 		if (e < 0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
			"cannot raise an integral value to a negative power ({0}^{1})", 
			k, e);
		}
	 ...
	 * @exception IllegalArgumentException
	 * 		if e is negative
	 */ 	public static java.math.BigInteger pow(final java.math.BigInteger k, int e) throws java.lang.IllegalArgumentException { 		if (e < 0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
			"cannot raise an integral value to a negative power ({0}^{1})", 
			k, e);
		}
	 ...
	 * @exception IllegalArgumentException
	 * 		if e is negative
	 */ 	public static java.math.BigInteger pow(final java.math.BigInteger k, long e) throws java.lang.IllegalArgumentException { 		if (e < 0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
			"cannot raise an integral value to a negative power ({0}^{1})", 
			k, e);
		}
	 ...
	 * @exception IllegalArgumentException
	 * 		if e is negative
	 */ 	public static java.math.BigInteger pow(final java.math.BigInteger k, java.math.BigInteger e) throws java.lang.IllegalArgumentException { 		if (e.compareTo(java.math.BigInteger.ZERO) < 0) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
			"cannot raise an integral value to a negative power ({0}^{1})", 
			k, e);
		}
	 ...
	 */ 	public static void checkOrder(double[] val, int dir, boolean strict) { 		double previous = val[0]; 		int max = val.length;
		for (int i = 1; i < max; i++) {
			if (dir > 0) {
				if (strict) {
					if (val[i] <= previous) {
						throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("points {0} and {1} are not strictly increasing ({2} >= {3})", 
						i - 1, i, previous, val[i]);
					}
				} else 
				if (val[i] < previous) {
					throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("points {0} and {1} are not increasing ({2} > {3})", 
					i - 1, i, previous, val[i]);
				}
			...
			if (strict) {
				if (val[i] >= previous) {
					throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("points {0} and {1} are not strictly decreasing ({2} <= {3})", 
					i - 1, i, previous, val[i]);
				}
			} else 
			if (val[i] > previous) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("points {0} and {1} are not decreasing ({2} < {3})", 
				i - 1, i, previous, val[i]);
			}
