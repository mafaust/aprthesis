...
org.apache.commons.math.distribution.IntegerDistribution , java.io.Serializable {
	 ...
	 */ 	@java.lang.Override 	public double cumulativeProbability(double x0, double x1) throws org.apache.commons.math.MathException { 		if (x0 > x1) {
			...
			org.apache.commons.math.distribution.AbstractIntegerDistribution.WRONG_ORDER_ENDPOINTS_MESSAGE, x0, x1);
		}
	 ...
	 * @throws IllegalArgumentException
	 * 		if x0 > x1
	 */ 	public double cumulativeProbability(int x0, int x1) throws org.apache.commons.math.MathException { 		if (x0 > x1) { 			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.distribution.AbstractIntegerDistribution.WRONG_ORDER_ENDPOINTS_MESSAGE, x0, x1);
		}
	 ...
	 */ 	public int inverseCumulativeProbability(final double p) throws org.apache.commons.math.MathException { 		if ((p < 0.0) || (p > 1.0)) { 			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
			org.apache.commons.math.distribution.AbstractIntegerDistribution.OUT_OF_RANGE_POINT, p, 0.0, 1.0);
		}
