...
org.apache.commons.math.distribution.NormalDistribution , java.io.Serializable {
	 ...
	 */ 	public NormalDistributionImpl(double mean, double sd) { 		super(); 		setMean(mean);
	 ...
	 */ 	public void setStandardDeviation(double sd) { 		if (sd <= 0.0) { 			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
