...
org.apache.commons.math.distribution.ContinuousDistribution , java.io.Serializable {
	 ...
	 */ 	public double inverseCumulativeProbability(final double p) throws org.apache.commons.math.MathException { 		if ((p < 0.0) || (p > 1.0)) {
		...
		try {
			 ...
			 */
			if (
			java.lang.Math.abs(rootFindingFunction.value(lowerBound)) < 1.0E-6) {
				return lowerBound;
			}
		...
		// find root
		double root = org.apache.commons.math.analysis.solvers.UnivariateRealSolverUtils.solve(rootFindingFunction, 
		bracket[0], bracket[1]);
		return root;
	}
