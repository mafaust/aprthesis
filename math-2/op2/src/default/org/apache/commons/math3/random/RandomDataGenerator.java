...
public class RandomDataGenerator implements org.apache.commons.math3.random.RandomData , java.io.Serializable {
	 ...
	 * 		if {@code len <= 0}.
	 */ 	public java.lang.String nextHexString(int len) throws org.apache.commons.math3.exception.NotStrictlyPositiveException { 		if (len <= 0) {
	...
	/**
	 * {@inheritDoc }
	 */ 	public int nextInt(final int lower, final int upper) throws org.apache.commons.math3.exception.NumberIsTooLargeException { 		return new org.apache.commons.math3.distribution.UniformIntegerDistribution(getRandomGenerator(), lower, upper).sample();
	}

	/**
	 * {@inheritDoc }
	 */ 	public long nextLong(final long lower, final long upper) throws org.apache.commons.math3.exception.NumberIsTooLargeException { 		if (lower >= upper) {
			throw new org.apache.commons.math3.exception.NumberIsTooLargeException(org.apache.commons.math3.exception.util.LocalizedFormats.LOWER_BOUND_NOT_BELOW_UPPER_BOUND, 
			lower, upper, false);
		}
	 ...
	 */ 	private static long nextLong(final org.apache.commons.math3.random.RandomGenerator rng, final long n) throws java.lang.IllegalArgumentException { 		if (n > 0) { 			final byte[] byteArray = new byte[8];
			long bits;
			long val;
			do {
	 ...
	 * @throws NotStrictlyPositiveException
	 * 		if {@code len <= 0}
	 */ 	public java.lang.String nextSecureHexString(int len) throws org.apache.commons.math3.exception.NotStrictlyPositiveException { 		if (len <= 0) {
			throw new org.apache.commons.math3.exception.NotStrictlyPositiveException(org.apache.commons.math3.exception.util.LocalizedFormats.LENGTH, len);
		}
	...
	/**
	 * {@inheritDoc }
	 */ 	public int nextSecureInt(final int lower, final int upper) throws org.apache.commons.math3.exception.NumberIsTooLargeException { 		return new org.apache.commons.math3.distribution.UniformIntegerDistribution(getSecRan(), lower, upper).sample();
	}

	/**
	 * {@inheritDoc }
	 */ 	public long nextSecureLong(final long lower, final long upper) throws org.apache.commons.math3.exception.NumberIsTooLargeException { 		if (lower >= upper) {
			throw new org.apache.commons.math3.exception.NumberIsTooLargeException(org.apache.commons.math3.exception.util.LocalizedFormats.LOWER_BOUND_NOT_BELOW_UPPER_BOUND, 
			lower, upper, false);
		}
	 ...
	 * @throws NotStrictlyPositiveException
	 * 		if {@code len <= 0}
	 */ 	public long nextPoisson(double mean) throws org.apache.commons.math3.exception.NotStrictlyPositiveException { 		return new org.apache.commons.math3.distribution.PoissonDistribution(getRandomGenerator(), mean, 
		org.apache.commons.math3.distribution.PoissonDistribution.DEFAULT_EPSILON, 
		org.apache.commons.math3.distribution.PoissonDistribution.DEFAULT_MAX_ITERATIONS).sample();
	}

	/**
	 * {@inheritDoc }
	 */ 	public double nextGaussian(double mu, double sigma) throws org.apache.commons.math3.exception.NotStrictlyPositiveException { 		if (sigma <= 0) {
	...
	public double nextExponential(double mean) throws org.apache.commons.math3.exception.NotStrictlyPositiveException {
		return new org.apache.commons.math3.distribution.ExponentialDistribution(getRandomGenerator(), mean, 
		org.apache.commons.math3.distribution.ExponentialDistribution.DEFAULT_INVERSE_ABSOLUTE_ACCURACY).sample();
	}
	 ...
	 * 		range {@code [0, 1]}.
	 */ 	public int nextPascal(int r, double p) throws org.apache.commons.math3.exception.NotStrictlyPositiveException, org.apache.commons.math3.exception.OutOfRangeException { 		return new org.apache.commons.math3.distribution.PascalDistribution(getRandomGenerator(), r, p).sample();}
	/**
	 ...
	 * @throws NotStrictlyPositiveException
	 * 		if {@code df <= 0}
	 */ 	public double nextT(double df) throws org.apache.commons.math3.exception.NotStrictlyPositiveException { 		return new org.apache.commons.math3.distribution.TDistribution(getRandomGenerator(), df, 
		org.apache.commons.math3.distribution.TDistribution.DEFAULT_INVERSE_ABSOLUTE_ACCURACY).sample();
	}
	 ...
	 * 		or {@code exponent <= 0}.
	 */ 	public int nextZipf(int numberOfElements, double exponent) throws org.apache.commons.math3.exception.NotStrictlyPositiveException { 		return new org.apache.commons.math3.distribution.ZipfDistribution(getRandomGenerator(), numberOfElements, exponent).sample();}
	 ...
	 */ 	public double nextBeta(double alpha, double beta) { 		return new org.apache.commons.math3.distribution.BetaDistribution(getRandomGenerator(), alpha, beta, 
		org.apache.commons.math3.distribution.BetaDistribution.DEFAULT_INVERSE_ABSOLUTE_ACCURACY).sample();
	}
	 ...
	 */ 	public int nextBinomial(int numberOfTrials, double probabilityOfSuccess) { 		return new org.apache.commons.math3.distribution.BinomialDistribution(getRandomGenerator(), numberOfTrials, probabilityOfSuccess).sample();
	}
	 ...
	 */ 	public double nextCauchy(double median, double scale) { 		return new org.apache.commons.math3.distribution.CauchyDistribution(getRandomGenerator(), median, scale, 
		org.apache.commons.math3.distribution.CauchyDistribution.DEFAULT_INVERSE_ABSOLUTE_ACCURACY).sample();
	}
	 ...
	 */ 	public double nextChiSquare(double df) {
		return new org.apache.commons.math3.distribution.ChiSquaredDistribution(getRandomGenerator(), df, 
		org.apache.commons.math3.distribution.ChiSquaredDistribution.DEFAULT_INVERSE_ABSOLUTE_ACCURACY).sample();
	}
	 ...
	 */ 	public double nextF(double numeratorDf, double denominatorDf) throws org.apache.commons.math3.exception.NotStrictlyPositiveException { 		return new org.apache.commons.math3.distribution.FDistribution(getRandomGenerator(), numeratorDf, denominatorDf, org.apache.commons.math3.distribution.FDistribution.DEFAULT_INVERSE_ABSOLUTE_ACCURACY).sample();
	}
	 ...
	 */ 	public double nextUniform(double lower, double upper) throws org.apache.commons.math3.exception.NumberIsTooLargeException, org.apache.commons.math3.exception.NotFiniteNumberException, org.apache.commons.math3.exception.NotANumberException { 		return nextUniform(lower, upper, false);}
	 ...
	 * @throws NotStrictlyPositiveException
	 * 		if {@code k <= 0}.
	 */ 	public int[] nextPermutation(int n, int k) throws org.apache.commons.math3.exception.NumberIsTooLargeException, org.apache.commons.math3.exception.NotStrictlyPositiveException { 		if (k > n) {
			throw new org.apache.commons.math3.exception.NumberIsTooLargeException(org.apache.commons.math3.exception.util.LocalizedFormats.PERMUTATION_EXCEEDS_N, 
			k, n, true);
		}
		if (k <= 0) {
			throw new org.apache.commons.math3.exception.NotStrictlyPositiveException(org.apache.commons.math3.exception.util.LocalizedFormats.PERMUTATION_SIZE, 
			k);
		}
	...
	public java.lang.Object[] nextSample(java.util.Collection<?> c, int k) throws org.apache.commons.math3.exception.NumberIsTooLargeException, org.apache.commons.math3.exception.NotStrictlyPositiveException {
		...
		int len = c.size();
		if (k > len) {
			throw new org.apache.commons.math3.exception.NumberIsTooLargeException(org.apache.commons.math3.exception.util.LocalizedFormats.SAMPLE_SIZE_EXCEEDS_COLLECTION_SIZE, 
			k, len, true);
		}
		if (k <= 0) {
	 ...
	 */ 	public void setSecureAlgorithm(java.lang.String algorithm, java.lang.String provider) throws java.security.NoSuchAlgorithmException, java.security.NoSuchProviderException { 		secRand = org.apache.commons.math3.random.RandomGeneratorFactory.createRandomGenerator(java.security.SecureRandom.getInstance(algorithm, provider));}
	 ...
	 */ 	private void shuffle(int[] list, int end) { 		int target = 0;
