...
public class RandomDataImpl implements org.apache.commons.math3.random.RandomData , java.io.Serializable {
	 ...
	 */ 	@java.lang.Deprecated 	org.apache.commons.math3.random.RandomDataGenerator getDelegate() {
		return delegate;
	}
	 ...
	 * 		if {@code len <= 0}.
	 */ 	public java.lang.String nextHexString(int len) throws org.apache.commons.math3.exception.NotStrictlyPositiveException { 		return delegate.nextHexString(len);
	}

	/**
	 * {@inheritDoc }
	 */ 	public int nextInt(int lower, int upper) throws org.apache.commons.math3.exception.NumberIsTooLargeException { 		return delegate.nextInt(lower, upper);
	}

	/**
	 * {@inheritDoc }
	 */ 	public long nextLong(long lower, long upper) throws org.apache.commons.math3.exception.NumberIsTooLargeException { 		return delegate.nextLong(lower, upper);
	}
	...
	/**
	 * {@inheritDoc }
	 */ 	public int nextSecureInt(int lower, int upper) throws org.apache.commons.math3.exception.NumberIsTooLargeException { 		return delegate.nextSecureInt(lower, upper);
	}

	/**
	 * {@inheritDoc }
	 */ 	public long nextSecureLong(long lower, long upper) throws org.apache.commons.math3.exception.NumberIsTooLargeException { 		return delegate.nextSecureLong(lower, upper);
	}
	...
	/**
	 * {@inheritDoc }
	 */ 	public double nextGaussian(double mu, double sigma) throws org.apache.commons.math3.exception.NotStrictlyPositiveException { 		return delegate.nextGaussian(mu, sigma);
	}
	 ...
	 * </p>
	 */
	public double nextUniform(double lower, double upper) throws 
	org.apache.commons.math3.exception.NumberIsTooLargeException, org.apache.commons.math3.exception.NotFiniteNumberException, org.apache.commons.math3.exception.NotANumberException {
	 ...
	 *
	 * @since 3.0
	 */ 	public double nextUniform(double lower, double upper, boolean lowerInclusive) throws 
	org.apache.commons.math3.exception.NumberIsTooLargeException, org.apache.commons.math3.exception.NotFiniteNumberException, org.apache.commons.math3.exception.NotANumberException {
	 ...
	 * @since 2.2
	 */ 	public double nextBeta(double alpha, double beta) { 		return delegate.nextBeta(alpha, beta);
	}
	 ...
	 * @since 2.2
	 */ 	public int nextBinomial(int numberOfTrials, double probabilityOfSuccess) { 		return delegate.nextBinomial(numberOfTrials, probabilityOfSuccess);
	}
	 ...
	 * @since 2.2
	 */ 	public double nextF(double numeratorDf, double denominatorDf) throws org.apache.commons.math3.exception.NotStrictlyPositiveException { 		return delegate.nextF(numeratorDf, denominatorDf);}
	 ...
	 * 		{@code scale <= 0}.
	 * @since 2.2
	 */ 	public double nextGamma(double shape, double scale) throws org.apache.commons.math3.exception.NotStrictlyPositiveException { 		return delegate.nextGamma(shape, scale);}
	 ...
	 * 		range {@code [0, 1]}.
	 */ 	public int nextPascal(int r, double p) throws org.apache.commons.math3.exception.NotStrictlyPositiveException, org.apache.commons.math3.exception.OutOfRangeException { 		return delegate.nextPascal(r, p);}
	 ...
	 * @throws NotStrictlyPositiveException
	 * 		if {@code df <= 0}
	 */ 	public double nextT(double df) throws org.apache.commons.math3.exception.NotStrictlyPositiveException { 		return delegate.nextT(df);
	}
	 ...
	 * 		if {@code shape <= 0} or
	 * 		{@code scale <= 0}.
	 */ 	public double nextWeibull(double shape, double scale) throws org.apache.commons.math3.exception.NotStrictlyPositiveException { 		return delegate.nextWeibull(shape, scale);}
	 ...
	 * 		or {@code exponent <= 0}.
	 */ 	public int nextZipf(int numberOfElements, double exponent) throws org.apache.commons.math3.exception.NotStrictlyPositiveException { 		return delegate.nextZipf(numberOfElements, exponent);}
	 ...
	 * </p>
	 */
	public int[] nextPermutation(int n, int k) throws 
	org.apache.commons.math3.exception.NotStrictlyPositiveException, org.apache.commons.math3.exception.NumberIsTooLargeException {
	 ...
	 * </p>
	 */
	public java.lang.Object[] nextSample(java.util.Collection<?> c, int k) throws 
	org.apache.commons.math3.exception.NotStrictlyPositiveException, org.apache.commons.math3.exception.NumberIsTooLargeException {
	 ...
	 */ 	@java.lang.Deprecated 	public double nextInversionDeviate(org.apache.commons.math3.distribution.RealDistribution distribution) throws 
	 ...
	 * @since 2.2
	 * @deprecated use the distribution's sample() method
	 */ 	@java.lang.Deprecated 	public int nextInversionDeviate(org.apache.commons.math3.distribution.IntegerDistribution distribution) throws 
	org.apache.commons.math3.exception.MathIllegalArgumentException {
		return distribution.inverseCumulativeProbability(nextUniform(0, 1));
	}}