...
public class ExceptionContext implements java.io.Serializable {
	 ...
	 */ 	public ExceptionContext(final java.lang.Throwable throwable) { 		this.throwable = throwable; 		msgPatterns = new java.util.ArrayList<org.apache.commons.math3.exception.util.Localizable>();
	 ...
	 */ 	public java.lang.Throwable getThrowable() { 		return throwable;
	}
	 ...
	 * @param value
	 * 		Context value.
	 */ 	public void setValue(java.lang.String key, java.lang.Object value) { 		context.put(key, value);
	}
