...
public class FastMath { 	/**
	 ...
	 */ 	private static final double[][] LN_QUICK_COEF = new double[][]{ new double[]{ 1.0, 5.669184079525E-24 }, 
	 ...
	 */ 	private static final double[][] LN_HI_PREC_COEF = new double[][]{ new double[]{ 1.0, -6.032174644509064E-23 }, 
	new double[]{ -0.25, -0.25 }, 
	...
	/**
	 * Table of 2^((n+2)/3)
	 */ 	private static final double[] CBRTTWO = new double[]{ 0.6299605249474366, 0.7937005259840998, 
	1.0, 
	1.2599210498948732, 
	1.5874010519681994 };
	 ...
	 */ 	private static final long MASK_30BITS = (-1L) - (org.apache.commons.math3.util.FastMath.HEX_40000000 - 1);// 0xFFFFFFFFC0000000L;
	/**
	 ...
	 */ 	private static double doubleHighPart(double d) {
		...
		long xl = java.lang.Double.doubleToRawLongBits(d);// can take raw bits because just gonna convert it back
		xl = xl & org.apache.commons.math3.util.FastMath.MASK_30BITS;// Drop low order bits
	 ...
	 */ 	public static double sqrt(final double a) { 		return java.lang.Math.sqrt(a);}
	 ...
	 */ 	public static double sinh(double x) { 		boolean negate = false; 		if (x != x) {
			return x;
		}
	 ...
	 */ 	public static double tanh(double x) { 		boolean negate = false;
		if (x != x) {
			return x;
		}
	 ...
	 */ 	public static double acosh(final double a) { 		return org.apache.commons.math3.util.FastMath.log(a + org.apache.commons.math3.util.FastMath.sqrt((a * a) - 1));}
	 ...
	 */ 	public static double asinh(double a) { 		boolean negative = false; 		if (a < 0) {
			negative = true;
			a = -a;
		}
	 ...
	 */ 	public static double atanh(double a) { 		boolean negative = false; 		if (a < 0) {
			negative = true;
			a = -a;
		}
	 ...
	 */ 	public static double nextUp(final double a) { 		return org.apache.commons.math3.util.FastMath.nextAfter(a, java.lang.Double.POSITIVE_INFINITY);}
	 ...
	 * 		number to which neighbor should be computed
	 * @return neighbor of a towards positive infinity
	 */ 	public static float nextUp(final float a) { 		return org.apache.commons.math3.util.FastMath.nextAfter(a, java.lang.Float.POSITIVE_INFINITY);}
	 ...
	 * @return exp(x)
	 */ 	private static double exp(double x, double extra, double[] hiPrec) { 		double intPartA; 		double intPartB; 		int intVal;
		...
		if (x < 0.0) {
			...
			if (intVal > 709) {
				...
				final double result = org.apache.commons.math3.util.FastMath.exp(x + 40.19140625, extra, hiPrec) / 2.8504009514401178E17;
				if (hiPrec != null) {
	 ...
	 * @return exp(x) - 1
	 */ 	public static double expm1(double x) { 		return org.apache.commons.math3.util.FastMath.expm1(x, null);}
	 ...
	 * 		a number
	 * @return log10(x)
	 */ 	public static double log10(final double x) { 		final double[] hiPrec = new double[2];
	 ...
	 */ 	public static double log(double base, double x) { 		return org.apache.commons.math3.util.FastMath.log(x) / org.apache.commons.math3.util.FastMath.log(base);
	}
	 ...
	 * @return sin(xa + xb)
	 */ 	private static double sinQ(double xa, double xb) { 		int idx = ((int) ((xa * 8.0) + 0.5)); 		final double epsilon = xa - org.apache.commons.math3.util.FastMath.EIGHTHS[idx];// idx*0.125;
	 ...
	 */ 	private static double tanQ(double xa, double xb, boolean cotanFlag) { 		int idx = ((int) ((xa * 8.0) + 0.5)); 		final double epsilon = xa - org.apache.commons.math3.util.FastMath.EIGHTHS[idx];// idx*0.125;
	 ...
	 */ 	private static void reducePayneHanek(double x, double[] result) { 		/* Convert input double to bits */
		...
		/* Convert to double */
		double tmpA = (prod2A >>> 12) / org.apache.commons.math3.util.FastMath.TWO_POWER_52;// High order 52 bits
		double tmpB = ((((prod2A & 0xfffL) << 40) + (prod2B >>> 24)) / org.apache.commons.math3.util.FastMath.TWO_POWER_52) / org.apache.commons.math3.util.FastMath.TWO_POWER_52;// Low bits
	 ...
	 * 		a number
	 * @return atan(x)
	 */ 	public static double atan(double x) { 		return org.apache.commons.math3.util.FastMath.atan(x, 0.0, false);
	}
	 ...
	 */ 	public static double cbrt(double x) { 		/* Convert input double to bits */ 		long inbits = java.lang.Double.doubleToRawLongBits(x);
		int exponent = ((int) ((inbits >> 52) & 0x7ff)) - 1023;
		...
		double p2 = java.lang.Double.longBitsToDouble((inbits & 0x8000000000000000L) | 
	 ...
	 * @return abs(x)
	 */ 	public static int abs(final int x) { 		final int i = x >>> 31;
		return (x ^ ((~i) + 1)) + i;
	}
	 ...
	 * 		number from which absolute value is requested
	 * @return abs(x)
	 */ 	public static long abs(final long x) { 		final long l = x >>> 63;
	 ...
	 * 		number from which absolute value is requested
	 * @return abs(x)
	 */ 	public static float abs(final float x) { 		return java.lang.Float.intBitsToFloat(org.apache.commons.math3.util.FastMath.MASK_NON_SIGN_INT & java.lang.Float.floatToRawIntBits(x));
	}
	 ...
	 * 		number from which absolute value is requested
	 * @return abs(x)
	 */ 	public static double abs(double x) { 		return java.lang.Double.longBitsToDouble(org.apache.commons.math3.util.FastMath.MASK_NON_SIGN_LONG & java.lang.Double.doubleToRawLongBits(x));
	}
	 ...
	 * @return ulp(x)
	 */ 	public static double ulp(double x) { 		if (java.lang.Double.isInfinite(x)) {
			return java.lang.Double.POSITIVE_INFINITY;
		}
	 ...
	 * 		number from which ulp is requested
	 * @return ulp(x)
	 */ 	public static float ulp(float x) { 		if (java.lang.Float.isInfinite(x)) {
	 ...
	 */ 	public static double scalb(final double d, final int n) { 		// first simple and fast handling when 2^n can be represented using normal numbers
		if ((n > (-1023)) && (n < 1024)) {
	 ...
	 */ 	public static float scalb(final float f, final int n) { 		// first simple and fast handling when 2^n can be represented using normal numbers
		if ((n > (-127)) && (n < 128)) {
	 ...
	 */ 	public static double floor(double x) { 		long y;
		if (x != x) { 			// NaN
			return x;
		}
	 ...
	 */ 	public static double rint(double x) { 		double y = org.apache.commons.math3.util.FastMath.floor(x); 		double d = x - y;
	 ...
	 */ 	public static long round(double x) { 		return ((long) (org.apache.commons.math3.util.FastMath.floor(x + 0.5)));}
	 ...
	 */ 	public static int round(final float x) { 		return ((int) (org.apache.commons.math3.util.FastMath.floor(x + 0.5F)));}
	 ...
	 * 		second value
	 * @return a if a is lesser or equal to b, b otherwise
	 */ 	public static float min(final float a, final float b) { 		if (a > b) { 			return b;}
		if (a < b) {
			return a;
		}
	 ...
	 * 		second value
	 * @return a if a is lesser or equal to b, b otherwise
	 */ 	public static double min(final double a, final double b) { 		if (a > b) { 			return b;}
		if (a < b) {
			return a;
		}
		/* if either arg is NaN, return NaN */
	 ...
	 * 		second value
	 * @return b if a is lesser or equal to b, a otherwise
	 */ 	public static float max(final float a, final float b) { 		if (a > b) { 			return a;}
		if (a < b) {
			return b;
		}
		/* if either arg is NaN, return NaN */
	 ...
	 * 		second value
	 * @return b if a is lesser or equal to b, a otherwise
	 */ 	public static double max(final double a, final double b) { 		if (a > b) { 			return a;}
		if (a < b) {
			return b;
		}
		/* if either arg is NaN, return NaN */
	 ...
	 */ 	public static double hypot(final double x, final double y) { 		if (java.lang.Double.isInfinite(x) || java.lang.Double.isInfinite(y)) {
			return java.lang.Double.POSITIVE_INFINITY;
	 ...
	 */ 	public static double IEEEremainder(double dividend, double divisor) { 		return java.lang.StrictMath.IEEEremainder(dividend, divisor);// TODO provide our own implementation
	}
	/**
	 ...
	 */ 	public static double copySign(double magnitude, double sign) { 		// The highest order bit is going to be zero if the
		// highest order bit of m and s is the same and one otherwise.
		// So (m^s) will be positive if both m and s have the same sign
		// and negative otherwise.
		final long m = java.lang.Double.doubleToRawLongBits(magnitude);// don't care about NaN
	 ...
	 * 		the sign for the returned value
	 * @return the magnitude with the same sign as the {@code sign} argument
	 */ 	public static float copySign(float magnitude, float sign) { 		// The highest order bit is going to be zero if the
		// highest order bit of m and s is the same and one otherwise.
		// So (m^s) will be positive if both m and s have the same sign
		// and negative otherwise.
	 ...
	 */ 	public static int getExponent(final double d) { 		// NaN and Infinite will return 1024 anywho so can use raw bits
	 ...
	 * 		number from which exponent is requested
	 * @return exponent for d in IEEE754 representation, without bias
	 */ 	public static int getExponent(final float f) { 		// NaN and Infinite will return the same exponent anywho so can use raw bits
	 ...
	 * @param a
	 * 		unused
	 */ 	public static void main(java.lang.String[] a) { 		java.io.PrintStream out = java.lang.System.out;
	 ...
	 */ 	private static class ExpIntTable { 		/**
		...
		static 
		{
			if (org.apache.commons.math3.util.FastMath.RECOMPUTE_TABLES_AT_RUNTIME) {
				org.apache.commons.math3.util.FastMath.ExpIntTable.EXP_INT_TABLE_A = new double[org.apache.commons.math3.util.FastMath.EXP_INT_TABLE_LEN];
				org.apache.commons.math3.util.FastMath.ExpIntTable.EXP_INT_TABLE_B = new double[org.apache.commons.math3.util.FastMath.EXP_INT_TABLE_LEN];
				...
				org.apache.commons.math3.util.FastMath.ExpIntTable.EXP_INT_TABLE_A = org.apache.commons.math3.util.FastMathLiteralArrays.loadExpIntA();
				org.apache.commons.math3.util.FastMath.ExpIntTable.EXP_INT_TABLE_B = org.apache.commons.math3.util.FastMathLiteralArrays.loadExpIntB();
			}
		}
	}
	 ...
	 */ 	private static class ExpFracTable { 		/**
		...
		{
			if (org.apache.commons.math3.util.FastMath.RECOMPUTE_TABLES_AT_RUNTIME) {
				org.apache.commons.math3.util.FastMath.ExpFracTable.EXP_FRAC_TABLE_A = new double[org.apache.commons.math3.util.FastMath.EXP_FRAC_TABLE_LEN];
				org.apache.commons.math3.util.FastMath.ExpFracTable.EXP_FRAC_TABLE_B = new double[org.apache.commons.math3.util.FastMath.EXP_FRAC_TABLE_LEN];
				...
				org.apache.commons.math3.util.FastMath.ExpFracTable.EXP_FRAC_TABLE_A = org.apache.commons.math3.util.FastMathLiteralArrays.loadExpFracA();
				org.apache.commons.math3.util.FastMath.ExpFracTable.EXP_FRAC_TABLE_B = org.apache.commons.math3.util.FastMathLiteralArrays.loadExpFracB();
			}
		}
	}
	 ...
	 */ 	private static class lnMant { 		/**
		...
		static {
			if (org.apache.commons.math3.util.FastMath.RECOMPUTE_TABLES_AT_RUNTIME) {
				org.apache.commons.math3.util.FastMath.lnMant.LN_MANT = new double[org.apache.commons.math3.util.FastMath.LN_MANT_LEN][];
				...
				org.apache.commons.math3.util.FastMath.lnMant.LN_MANT = org.apache.commons.math3.util.FastMathLiteralArrays.loadLnMant();
			}
		}
	}
	 ...
	 */ 	private static class CodyWaite { 		/**
		 ...
		 * @param xa
		 * 		Argument.
		 */ 		CodyWaite(double xa) { 			// Estimate k. 			// k = (int)(xa / 1.5707963267948966);
